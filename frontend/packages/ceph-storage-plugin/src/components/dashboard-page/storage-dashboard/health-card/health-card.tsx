...
import { getCephHealthState, processCephHealthState } from './utils';
...
const HealthCard: React.FC<DashboardItemProps> = ({
  ...
  }, [watchK8sResource, stopWatchK8sResource,watchPrometheus, stopWatchPrometheusQuery, watchAlerts, stopWatchAlerts]);
