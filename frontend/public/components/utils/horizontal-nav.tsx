...
import { HorizontalNavFacadeProps, NavPage } from '@console/dynamic-plugin-sdk/src/api/api';
      ...
      return (
        <ErrorBoundary FallbackComponent={ErrorBoundaryFallback}>
          <p.component
            ...
            {...extraResources}
            {...p.pageData}
            {..._.omit(params, 'match')} // match is being pushed as part of componentProps
            params={params} //Todo: This should be removed
...
export type Page = Omit<NavPage, 'component'> & {
  path?: string;
  nameKey?: string;
